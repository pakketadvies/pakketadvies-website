-- Migration: Add verbruik_type to contract_details_maatwerk
-- Date: 2025-01-XX
...
CREATE INDEX IF NOT EXISTS idx_contract_details_maatwerk_verbruik_type 
ON contract_details_maatwerk(verbruik_type);

-- Add comment
COMMENT ON COLUMN contract_details_maatwerk.verbruik_type IS 
