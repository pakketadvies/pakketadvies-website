#!/usr/bin/env node
/**
 * Test verschillende locaties voor agreedAdvancePaymentAmount fields
 */
...
async function testFieldLocations() {
  console.log('🧪 Test verschillende locaties voor agreedAdvancePaymentAmount fields...\n')
  ...
  const testCases = [
    {
      name: 'Test 1: Alleen op root level (niet in requestedConnections)',
      payload: {
        relation: {
          type: 'CONSUMER',
          firstName: 'Jan',
        ...
        agreedAdvancePaymentAmountElectricity: '100.00', // Op root level
        agreedAdvancePaymentAmountGas: '0.00', // Op root level
      },
    },
    {
      name: 'Test 2: In relation object',
      payload: {
        relation: {
          type: 'CONSUMER',
          firstName: 'Jan',
          ...
          paymentMethod: 'AUTOMATICCOLLECTION',
          mandateDate: '2026-01-06',
          agreedAdvancePaymentAmountElectricity: '100.00', // In relation
          agreedAdvancePaymentAmountGas: '0.00', // In relation
        },
        requestedConnections: [{
          postalCode: '1234AB',
          houseNumber: 1,
    ...
    {
      name: 'Test 3: In requestedConnections[0] (huidige locatie) + root level',
      payload: {
        relation: {
          type: 'CONSUMER',
          firstName: 'Jan',
        ...
        originalCreateTimestamp: formatDateTime(now),
        agreedAdvancePaymentAmount: '100.00',
        agreedAdvancePaymentAmountElectricity: '100.00', // Ook op root level
        agreedAdvancePaymentAmountGas: '0.00', // Ook op root level
      },
    },
    {
      name: 'Test 4: Alleen als hasElectricity/hasGas true is',
      payload: {
        relation: {
          type: 'CONSUMER',
          firstName: 'Jan',
        ...
        requestedConnections: [{
          ...
          hasGas: false,
          customerApprovalLEDs: true,
          // Alleen electricity omdat hasGas = false
          agreedAdvancePaymentAmountElectricity: '100.00',
          // Geen gas field omdat hasGas = false
        }],
        productID: '1',
        tariffID: '37',
        customerApprovalIDs: [1, 2, 3],
  ...
  for (const testCase of testCases) {
    ...
    try {
      ...
      if (response.ok) {
        console.log('✅ SUCCESS! Deze locatie werkt!')
        ...
        if (!hasAdvancePaymentErrors) {
          ...
          console.log('   Overige errors:', JSON.stringify(responseData.errors, null, 2))
        } else {
...
testFieldLocations().catch(console.error)
