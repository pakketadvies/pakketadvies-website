                    ...
                    {breakdown && !loading && (
                      <div className="mt-4 space-y-4">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                          ...
                          {/* Dynamische prijsinformatie (spotprijs + opslag) - ALTIJD TONEN */}
                          {breakdown.dynamischePrijzen && (
                            <details className="mt-4 text-xs text-gray-600 bg-blue-50 rounded-lg p-3 border border-blue-200">
                              ...
                              <div className="mt-3 space-y-3">
                                ...
                                <div className="space-y-1">
                                  <div className="font-medium text-gray-700">Elektriciteit (enkeltarief):</div>
                                ...
                                <div className="space-y-1 pt-2 border-t border-blue-200">
                                  <div className="font-medium text-gray-700">Teruglevering (naar net):</div>
                                  <div className="pl-3 space-y-0.5 text-gray-600">
                                    <div className="flex justify-between">
                                      <span>• Spotprijs (30d gem.):</span>
                                      <span className="font-mono">€{breakdown.dynamischePrijzen.spotprijzen.elektriciteitDag.toFixed(5)}/kWh</span>
                                    ...
                                    <div className="flex justify-between text-orange-700">
                                      <span>• Afslagtarief leverancier:</span>
                                      <span className="font-mono">-€{breakdown.dynamischePrijzen.opslagen.teruglevering.toFixed(5)}/kWh</span>
                                    </div>
                                    <div className="flex justify-between pt-1 border-t border-blue-300 font-semibold text-green-700">
                                      <span>= Netto vergoeding:</span>
                                      <span className="font-mono">€{(breakdown.dynamischePrijzen.spotprijzen.elektriciteitDag - breakdown.dynamischePrijzen.opslagen.teruglevering).toFixed(5)}/kWh</span>
                                    </div>
                                  </div>
                                </div>
