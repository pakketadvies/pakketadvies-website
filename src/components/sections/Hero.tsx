        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-8 pt-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-brand-purple-500/10 rounded-xl flex items-center justify-center">
                  <svg className="w-6 h-6 text-brand-purple-400" fill="currentColor" viewBox="0 0 20 20">
