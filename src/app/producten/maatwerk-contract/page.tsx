...
export default function MaatwerkContractPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <section className="bg-gradient-to-br from-purple-900 via-brand-navy-600 to-brand-navy-500 text-white py-12 md:py-16 pt-32 md:pt-36 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-3 bg-purple-500/20 border border-purple-400/30 rounded-full px-4 py-2 mb-6">
              <Diamond weight="duotone" className="w-5 h-5 text-purple-300" />
              <span className="text-sm font-semibold text-purple-200">Maatwerk Contract</span>
              <span className="bg-purple-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">Premium</span>
            </div>
            ...
            <div className="bg-purple-500/20 border border-purple-400/30 rounded-xl p-6 mb-8 max-w-2xl">
              <div className="flex items-center gap-3 mb-2">
                <Diamond weight="duotone" className="w-6 h-6 text-purple-300" />
                <span className="font-semibold text-purple-200">Geschikt voor:</span>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              {[
                ...
                return (
                  <div key={i} className="flex gap-5 bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all group">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-sm font-bold text-purple-600">STAP {item.step}</span>
                      </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 md:p-12">
              <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
                ...
                <div className="text-4xl font-bold text-purple-600 mb-1">15-25%</div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-purple-600">€18.500/jaar</span>
                </div>
                <div className="flex justify-between text-sm">
              ...
              return (
                <div key={i} className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-gray-200 hover:shadow-xl transition-all group">
                  <div className="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-purple-500 transition-colors">
                    <Icon weight="duotone" className="w-7 h-7 text-purple-600 group-hover:text-white transition-colors" />
                  </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container-custom">
          ...
          <div className="mt-12 bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-2xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact">
                <button className="px-8 py-4 bg-purple-700 hover:bg-purple-800 text-white rounded-xl font-semibold text-lg transition-all flex items-center justify-center gap-2">
                  <Handshake weight="duotone" className="w-6 h-6" />
                  Plan gesprek
                </button>
              </Link>
            ...
            {[
              ...
              <div key={i} className="flex gap-6 bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-sm font-bold text-purple-600">{step.week}</span>
                  </div>
      ...
      {/* CTA */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-purple-900 via-brand-navy-600 to-brand-navy-500 relative overflow-hidden">
