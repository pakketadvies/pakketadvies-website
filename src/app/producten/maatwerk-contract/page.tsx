      ...
      <section className="bg-gradient-to-br from-purple-900 via-brand-navy-600 to-brand-navy-500 text-white py-12 md:py-16 pt-32 md:pt-36 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-3 bg-brand-purple-500/20 border border-purple-400/30 rounded-full px-4 py-2 mb-6">
            ...
            <div className="bg-brand-purple-500/20 border border-purple-400/30 rounded-xl p-6 mb-8 max-w-2xl">
            ...
            {[
              ...
              return (
                <div key={i} className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-gray-200 hover:shadow-xl transition-all group">
                  <div className="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-brand-purple-500 transition-colors">
