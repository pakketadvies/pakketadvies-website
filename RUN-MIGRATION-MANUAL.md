...
Ga naar: https://supabase.com/dashboard/project/emmbycvdwkmugepvgtfj/sql/new
...
Voer daarna deze query uit om te controleren:

```sql
SELECT 
  jaar,
  eb_elektriciteit_kv_schijf1 as "EB Elektriciteit (€/kWh)",
  eb_gas_schijf1 as "EB Gas (€/m³)",
